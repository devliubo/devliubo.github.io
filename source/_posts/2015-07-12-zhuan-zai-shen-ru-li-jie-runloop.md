---
layout: post
title: '[转载]深入理解Runloop'
date: 2015-07-12 23:49:01
comments: true
author: devliubo
categories: iOS
tags: "runloop"
...
一篇讲解Runloop的好文章，转载一下，附上[原文链接 http://blog.ibireme.com/2015/05/18/runloop/](http://blog.ibireme.com/2015/05/18/runloop/)
...
tatic CFMutableDictionaryRef loopsDic;
...
CFRunLoopRef _CFRunLoopGet(pthread_t thread) {
	...
	if (!loop) {
		...
		CFSetTSD(..., thread, loop, __CFFinalizeRunLoop);
	}
...
![RunLoop_0]( /images/2015-07-12-zhuan-zai-shen-ru-li-jie-runloop/RunLoop_0.png)
...
![RunLoop_1]( /images/2015-07-12-zhuan-zai-shen-ru-li-jie-runloop/RunLoop_1.png)
...
![RunLoop_3]( /images/2015-07-12-zhuan-zai-shen-ru-li-jie-runloop/RunLoop_3.png)
...
![RunLoop_4]( /images/2015-07-12-zhuan-zai-shen-ru-li-jie-runloop/RunLoop_4.png)
...
![RunLoop_5]( /images/2015-07-12-zhuan-zai-shen-ru-li-jie-runloop/RunLoop_5.png)
...
![RunLoop_network]( /images/2015-07-12-zhuan-zai-shen-ru-li-jie-runloop/RunLoop_network.png)
